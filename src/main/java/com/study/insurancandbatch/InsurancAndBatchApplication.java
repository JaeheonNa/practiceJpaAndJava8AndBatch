package com.study.insurancandbatch;
...
@SpringBootApplication(scanBasePackages = {"com.study.insurancandbatch"})
@RequiredArgsConstructor
@EnableBatchProcessing
public class InsurancAndBatchApplication {

    public static void main(String[] args) {
        SpringApplication.run(InsurancAndBatchApplication.class, args);
    }
